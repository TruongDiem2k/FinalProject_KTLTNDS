...
public class PlayerSprintAndCrouch : MonoBehaviour {
    ...
    void Sprint() {
        ...
        // if we have stamina we can sprint = left Shift
        if(sprint_Value > 0f) {
            //Khi chay (nhan giu shift)
        ...
        if (Input.GetKey(KeyCode.LeftShift) && !is_Crouching) {
            ...
            //khong chay thi hoi lai the luc
    ...
    void Crouch() {
        ...
        if(Input.GetKeyDown(KeyCode.C)) {
            ...
            // if we are crouching - stand up nhan C
            if(is_Crouching) {
